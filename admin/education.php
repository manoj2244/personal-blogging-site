...
if(isset($_GET['delete'])){
  $sno = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `education` WHERE `id` = $sno";
...
if($_SERVER["REQUEST_METHOD"]=='POST'){
  ...
  $title4=mysqli_real_escape_string($db,$_POST['title4']);
    ...
    $sql="UPDATE `education` SET `title` = '$title', `description` = '$title1',`addresh`='$title3',`date`='$title4' WHERE `education`.`id` = $news_id;";
  ...
  $sql="INSERT INTO `education` (`title`, `description`,`addresh`,`date`) VALUES ('$title', '$title1','$title3','$title4')";
...
?>
  ...
  if($insert==1){
    ...
    Your education has been inserted successfully
    <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
  </div>";
  }
  if($insert==0){
   echo" <div class='alert alert-danger alert-dismissible fade show' role='alert'>
    Your education is not added sucessfully!
    <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
  </div>";
  }
  if($update==1){
  ...
  if($update==0){
   echo" <div class='alert alert-danger alert-dismissible fade show' role='alert'>
    Your education is not updated sucessfully!
    <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
  </div>";
  }
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this data!")) {
          console.log("yes");
          window.location = `../admin/education.php?delete=${sno}`;
