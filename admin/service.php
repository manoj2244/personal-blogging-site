...
if($_SERVER["REQUEST_METHOD"]=='POST'){
  ...
  $title2=mysqli_real_escape_string($db,$_POST['title2']);
    ...
    $sql="UPDATE `service` SET `title` = '$title', `description` = '$title1',`explore`='$title2' WHERE `service`.`id` = $news_id;";
  ...
  $sql="INSERT INTO `service` (`title`, `description`,`explore`) VALUES ('$title', '$title1','$title2')";
...
?>
  ...
  if($insert==1){
    ...
    Your service has been inserted successfully
    <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
  </div>";
  }
  if($insert==0){
   echo" <div class='alert alert-danger alert-dismissible fade show' role='alert'>
    Your service is not added sucessfully!
    <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
  </div>";
  }
  if($update==1){
  ...
  if($update==0){
   echo" <div class='alert alert-danger alert-dismissible fade show' role='alert'>
    Your service is not updated sucessfully!
    <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
  </div>";
  }
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this data!")) {
          console.log("yes");
          window.location = `../admin/service.php?delete=${sno}`;
